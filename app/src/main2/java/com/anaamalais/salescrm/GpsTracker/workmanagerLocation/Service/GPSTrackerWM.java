...
public class GPSTrackerWM extends Service implements LocationListener {
    ...
    public GPSTrackerWM(Context context) {
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            locationManager.removeUpdates(GPSTrackerWM.this);
        }
    }
