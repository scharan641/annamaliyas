...
public class TestDriveCompleteAdapter extends RecyclerView.Adapter<TestDriveCompleteAdapter.TestDriveCompleteViewHolder> {

    //this context we will use to inflate the activity_sign_in
    private Context mCtx;
    //we are storing all the products in a list
    private List<TestDriveCompletedList> testDriveCompletedLists;

    String followupdate , followuptime;

    //getting the context and product list with constructor
    public TestDriveCompleteAdapter(Context mCtx, List<TestDriveCompletedList> testDriveCompletedLists) {
        this.mCtx = mCtx;
        this.testDriveCompletedLists = testDriveCompletedLists;
    }

    @Override
    public TestDriveCompleteViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.adapter_contact_followup, null);

        return new TestDriveCompleteViewHolder(view);
    }

    @Override
    public void onBindViewHolder (final TestDriveCompleteViewHolder holder, int position){
        //getting the product of the specified position
        final TestDriveCompletedList allContactsList = testDriveCompletedLists.get(position);
    ...
    public int getItemCount () {
        return testDriveCompletedLists.size();
    }


    class TestDriveCompleteViewHolder extends RecyclerView.ViewHolder {

        TextView txt_count, txt_call_time, txt_type, txt_remark , txt_today_remark;

        public TestDriveCompleteViewHolder(View itemView) {
            super(itemView);
