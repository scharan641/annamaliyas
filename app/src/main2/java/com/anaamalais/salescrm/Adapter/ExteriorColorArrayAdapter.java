...
public class ExteriorColorArrayAdapter extends ArrayAdapter<String> {

    private final LayoutInflater mInflater;
    final Context mContext;
    private final List<ExteriorColorsList> items;
    private final int mResource;
    TextView offTypeTv;

    public ExteriorColorArrayAdapter(Context context, int resource,
                                         List objects) {
    ...
    private View createItemView(int position, View convertView, ViewGroup parent) {
        ...
        ExteriorColorsList offerData = items.get(position);
        if(position == 0){
