...
public class DeliveryCompletedAdapter extends RecyclerView.Adapter<DeliveryCompletedAdapter.DeliveryCompletedViewHolder> {
    //this context we will use to inflate the activity_sign_in
    private Context mCtx;
    //we are storing all the products in a list
    private List<DeliveryCompletedList> deliveryCompletedLists;

    String followupdate , followuptime;

    //getting the context and product list with constructor
    public DeliveryCompletedAdapter(Context mCtx, List<DeliveryCompletedList> deliveryCompletedLists) {
        this.mCtx = mCtx;
        this.deliveryCompletedLists = deliveryCompletedLists;
    }

    @Override
    public DeliveryCompletedViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder (final DeliveryCompletedViewHolder holder, int position){
        //getting the product of the specified position
        final DeliveryCompletedList allContactsList = deliveryCompletedLists.get(position);
    ...
    public int getItemCount () {
        return deliveryCompletedLists.size();
    }


    class DeliveryCompletedViewHolder extends RecyclerView.ViewHolder {

        TextView txt_count, txt_call_time, txt_type, txt_remark , txt_today_remark;

        public DeliveryCompletedViewHolder(View itemView) {
            super(itemView);
