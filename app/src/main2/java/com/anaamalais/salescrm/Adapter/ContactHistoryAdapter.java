...
public class ContactHistoryAdapter extends RecyclerView.Adapter<ContactHistoryAdapter.ContactHistoryViewHolder> {


    //this context we will use to inflate the activity_sign_in
    private Context mCtx;
    //we are storing all the products in a list
    private List<ContactHistoryList> contactHistoryLists;

    String followupdate , followuptime;

    //getting the context and product list with constructor
    public ContactHistoryAdapter(Context mCtx, List<ContactHistoryList> contactHistoryLists) {
        this.mCtx = mCtx;
        this.contactHistoryLists = contactHistoryLists;
    }
    ...
    @Override
    public void onBindViewHolder (final ContactHistoryViewHolder holder, int position){
        //getting the product of the specified position
        final ContactHistoryList allContactsList = contactHistoryLists.get(position);
    ...
    public int getItemCount () {
        return contactHistoryLists.size();
    }


    class ContactHistoryViewHolder extends RecyclerView.ViewHolder {
