...
import com.anaamalais.salescrm.HistoryActivity;
...
public class ContactFollowupAdapter extends RecyclerView.Adapter<ContactFollowupAdapter.ContactFollowupViewHolder> {
    ...
    public ContactFollowupAdapter(Context mCtx, List<Followup_details_List> followup_details_lists) {
        this.mCtx = mCtx;
        this.followup_details_lists = followup_details_lists;
    }

    @Override
    public ContactFollowupViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.adapter_contact_followup, null);

        return new ContactFollowupViewHolder(view);
    }

    @Override
    public void onBindViewHolder (final ContactFollowupViewHolder holder, int position){
    ...
    class ContactFollowupViewHolder extends RecyclerView.ViewHolder {

        TextView txt_count, txt_call_time, txt_type, txt_remark , txt_today_remark;

        public ContactFollowupViewHolder(View itemView) {
            super(itemView);
