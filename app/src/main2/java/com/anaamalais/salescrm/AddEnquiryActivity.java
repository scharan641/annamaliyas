...
import static com.anaamalais.salescrm.Utils.Constants.FOLLOWUPDATE;
import static com.anaamalais.salescrm.Utils.Constants.FOLLOWUPTIME;
...
public class AddEnquiryActivity  extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
   ...
   SwitchCompat swt_address_proof_attached,swt_intrested_in_utrust,swt_product_demo,swt_brouchure_given,swt_quotation_given,swt_extended_warranty,swt_smiles,
    ...
    String title_id , enquiry_id , mode_id , profession_id ,source_id , annual_income_id , company_type_id , vehicle_id , model_variant
   ...
   String productdemogiven , brochuregiven , quotationgiven , extended_warrantys , smiless
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Window window = AddEnquiryActivity.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(AddEnquiryActivity.this, R.color.white));
        requestQueue = Volley.newRequestQueue(AddEnquiryActivity.this);
        API_TOKEN = MyFunctions.getSharedPrefs(AddEnquiryActivity.this, Constants.TOKEN,"");
        ...
        txt_addition.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(AddEnquiryActivity.this, android.R.layout.simple_spinner_item, categories){
                    @Override
                    ...
                    public View getView(int position, View convertView, ViewGroup parent) {
                        ...
                        if (position == 0) {
                            ...
                            Typeface typeface = ResourcesCompat.getFont(AddEnquiryActivity.this, R.font.poppins);
        ...
        txt_replace.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Creating adapter for spinner
                ArrayAdapter<String> dataAdapterone = new ArrayAdapter<String>(AddEnquiryActivity.this, android.R.layout.simple_spinner_item, categories){
                    @Override
                    public boolean isEnabled(int position) {
                        if (position == 0) {
                            // Disable the first item from Spinner
         ...
         txt_individual.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressDialog = new ProgressDialog(AddEnquiryActivity.this);
                ...
                if (img_value_chain_down.getVisibility()==View.VISIBLE){
                  ...
                  /*  nest_scroll_view.post(new Runnable() {
                    ...
                    if (swt_smiles.isChecked()){
                        smiles = "1";
                      //  Toast.makeText(AddEnquiryActivity.this, "1", Toast.LENGTH_SHORT).show();
        ...
        edt_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(AddEnquiryActivity.this,
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (parent.getId()) {
            ...
            case R.id.spinner_title:
                ...
                MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.SPINNERTITLEID,title_id);
                break;
            ...
            case R.id.spinner_enquiry_type:
              //  String selectedItemText = Integer.toString(position);
                ...
                MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.SPINNERENQUIRYID,enquiry_id);
                break;
            case R.id.spinner_mode:
                ...
                if (position == 0) {
                    ...
                    MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.MODE,mode_id);
                    if (mode_id == null) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(AddEnquiryActivity.this);
                        builder.setTitle("USER MESSAGE");
            ...
            case R.id.spinner_source:
                ...
                MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.SPINNERSOURCEID,String.valueOf(position));
            ...
            case R.id.spinner_model_suffix_cop:
                if (position == 0) {
                   ...
                   // Customer_Get_Model_Variants();
                    ...
                    MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.VEHICLEID,vehicle_id);
                    if (vehicle_id == null) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(AddEnquiryActivity.this);
                        builder.setTitle("USER MESSAGE");
                        builder.setMessage("Please Select Mode First!!");
            ...
            case R.id.spinner_model_variant:
                if (position == 0) {
                    ...
                    MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.MODEL_VARIANT,String.valueOf(position));
            ...
            case R.id.spinner_interior_color:
               // interior_color_id = interiorColorsLists.get(position).getInterior_color_id();
                interior_color_id = interiorColorsLists.get(position).getInterior_color_id();
                MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.INTERIOR,String.valueOf(position));
                break;

            case R.id.spinner_exterEior_color:
                exterior_color_id = exteriorColorsLists.get(position).getExterior_color_id();
                MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.EXTEREIOR,String.valueOf(position));
                break;
            ...
            case R.id.spinner_finance_pitch:
                ...
                MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.FINANCEPITCHID,finance_pitch_id);
            ...
            case R.id.spinner_insurance_pitch:
                ...
                MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.INSURANCEPITCHID,insurance_master_id);
    ...
    public void back(View view) {
        startActivity(new Intent(AddEnquiryActivity.this,HomeActivity.class));
        finish();
    }
    ...
    public void validate_add_enquiery(){
        ...
        if (prospect_category.equals("1")){
            MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.PROSPECTCATEGORY,prospect_category);
            ...
            if (mode_id.equals("") || vehicle_id.equals("")||demand_structure_type.equals("")){
                Toast.makeText(AddEnquiryActivity.this, "", Toast.LENGTH_SHORT).show();
            }
            ...
            if (img_intrested_vehicle_up.getVisibility()==View.VISIBLE){
            ...
            ||(addressthree.toString().trim().length() < 6)) {
                Toast.makeText(AddEnquiryActivity.this, "Fill all the fields!!", Toast.LENGTH_SHORT).show();
                ...
                if (!response.equals(null)) {
                    ...
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            // Spinner adapter
                            EnquiryTitleTypeArrayAdapter adapter = new EnquiryTitleTypeArrayAdapter(AddEnquiryActivity.this, R.layout.layout_enquiry_type,
                                    titlesList);
                ...
                if (!response.equals(null)) {
                    ...
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            // Spinner adapter
                            EnquiryTypesArrayAdapter adapter = new EnquiryTypesArrayAdapter(AddEnquiryActivity.this,
                ...
                if (!response.equals(null)) {
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            ModeTypeArrayAdapter adapter = new ModeTypeArrayAdapter(AddEnquiryActivity.this,
                ...
                if (!response.equals(null)) {
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            SourceTypeArrayAdapter adapter = new SourceTypeArrayAdapter(AddEnquiryActivity.this,
                ...
                if (!response.equals(null)) {
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            ProfessionTypeArrayAdapter adapter = new ProfessionTypeArrayAdapter(AddEnquiryActivity.this,
                 ...
                 //   progressDialog.dismiss();
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            AnnualIncomeTypeArrayAdapter adapter = new AnnualIncomeTypeArrayAdapter(AddEnquiryActivity.this,
                ...
                if (!response.equals(null)) {
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            ModelsTypeArrayAdapter adapter = new ModelsTypeArrayAdapter(AddEnquiryActivity.this,
                ...
                if (!response.equals(null)) {
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            ModelVariantTypeArrayAdapter adapter = new ModelVariantTypeArrayAdapter(AddEnquiryActivity.this,
                ...
                if (!response.equals(null)) {
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            adapter = new InteriorColorTypeArrayAdapter(AddEnquiryActivity.this,
                ...
                if (!response.equals(null)) {
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            exadapter = new ExteriorColorArrayAdapter(AddEnquiryActivity.this,
                ...
                if (!response.equals(null)) {
                    ...
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            // Spinner adapter
                            FinancePitchTypeArrayAdapter adapter = new FinancePitchTypeArrayAdapter(AddEnquiryActivity.this, R.layout.layout_title_type,
                                    financePitchLists);
                ...
                if (!response.equals(null)) {
                    ...
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            // Spinner adapter
                            InsurancePitchTypeArrayAdapter adapter = new InsurancePitchTypeArrayAdapter(AddEnquiryActivity.this,
    ...
    public void EnquiryCreateenquiry() {
        StringRequest requests = new StringRequest(Request.Method.POST, createenquiry_url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                if (!response.equals(null)) {
                    progressDialog.dismiss();
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.CONTACT_ID,contact_id);
                            ...
                            MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.CUSTOMER_NAME,cus_name);
                            String cus_phone = (String)jsonObject.get("phone");
                            MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.CUSTOMER_PHONE,cus_phone);
                            String cus_address = (String)jsonObject.get("address");
                            MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.CUSTOMER_ADDRESS,cus_address);
                            String followupdate = jsonObject.getString("follow_up_date");
                            MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.FOLLOWUPDATE,followupdate);
                            String followuptime = jsonObject.getString("follow_up_time");
                            MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.FOLLOWUPTIME,followuptime);
                            String followuptype = jsonObject.getString("follow_up_type");
                            MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.FOLLOWUPTYPE,followuptype);
                            MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.FOLLOWUPTYPE,followuptype);
                            String followupid = jsonObject.getString("follow_up_id");
                            MyFunctions.setSharedPrefs(AddEnquiryActivity.this,Constants.FOLLOWUPID,followupid);
                            startActivity(new Intent(AddEnquiryActivity.this,CustomerDetailsActivity.class).putExtra("Status",contact_status));
                            finish();
                        } else if (status_code.equals("0")) {
                            msg = (String) jsonObj.getString("msg");
                            AlertDialog.Builder builder = new AlertDialog.Builder(AddEnquiryActivity.this);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("ENQUIRY_TYPE", enquiry_id);
                params.put("MODE_ID", mode_id);
                ...
                if (!response.equals(null)) {
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            EnquiryTitleTypeArrayAdapter adapter = new EnquiryTitleTypeArrayAdapter(AddEnquiryActivity.this,
...
//                    progressDialog.dismiss();
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            CompanyTypesArrayAdapter adapter = new CompanyTypesArrayAdapter(AddEnquiryActivity.this,
    ...
    public void Customer_Cop_Createnquiery(){
        StringRequest requests = new StringRequest(Request.Method.POST, createenquiry_url, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                if (!response.equals(null)) {
