...
public class AccessoriesList extends AppCompatActivity {
    TextView txt_model_price,txt_accessories_list_title , txt_start_acticity , txt_net_amount;
    ...
    List<InterioraccessoriesList> interioraccessoriesLists;
  ...
  //  String[]interioraccessories;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        interioraccessoriesLists = new ArrayList<>();
    ...
    public void back(View view) {
        startActivity(new Intent(AccessoriesList.this,CatalogueActivity.class));
        // finish();
    }
    ...
    public void addaccessories(View view) {
        if (STATUS.equals("Interior Accessories")){
            ...
            startActivity(new Intent(AccessoriesList.this,ModelDetailsActivity.class).putExtra("ID",MyFunctions.getSharedPrefs(AccessoriesList.this,Constants.MODEL_ID,"")).putExtra("MODEL_IMAGE",MyFunctions.getSharedPrefs(AccessoriesList.this,Constants.MODELIMAGE,"")));
        }else if (STATUS.equals("Exterior Accessories")){
                        ...
                        if(status_code.equals("1")){
                            ...
                            for (int k = 0 ; k < catalogue.length() ; k++){
                                ...
                                if (Variant_id.equals(variant_id)){
                                    ...
                                    interioraccessoriesLists.clear();
                                    for (int km = 0 ; km < color_data.length() ; km++){
                                        ...
                                        interioraccessoriesLists.add(model);
                                    }
                                    interioraccessoriesAdapter = new InterioraccessoriesAdapter(AccessoriesList.this, interioraccessoriesLists);
                            ...
                            for (int k = 0 ; k < catalogue.length() ; k++){
                                ...
                                if (Variant_id.equals(variant_id)){
                                    ...
                                    for (int km = 0 ; km < color_data.length() ; km++){
                                        ...
                                        exterioraccessoriesLists.add(model);
                                    }
                                    exterioraccessoriesAdapter = new ExteriorAccessoriesAdapter(AccessoriesList.this, exterioraccessoriesLists);
                            ...
                            for (int k = 0 ; k < catalogue.length() ; k++){
                                ...
                                if (Variant_id.equals(variant_id)){
                                    ...
                                    for (int km = 0 ; km < color_data.length() ; km++){
                                        ...
                                        utilityaccessoriesLists.add(model);
                                    }
                                    utilityAccessoriesAdapter = new UtilityAccessoriesAdapter(AccessoriesList.this, utilityaccessoriesLists);
