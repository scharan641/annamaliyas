...
public class FinanceActivity extends AppCompatActivity {
    ...
    RecyclerView rv_finance_model , rv_enquiry_mode;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        window.setStatusBarColor(ContextCompat.getColor(FinanceActivity.this, R.color.white));
        rv_finance_model = findViewById(R.id.rv_finance_model);
        rv_enquiry_mode  = findViewById(R.id.rv_enquiry_mode);
        requestQueue = Volley.newRequestQueue(FinanceActivity.this);
        API_TOKEN = MyFunctions.getSharedPrefs(FinanceActivity.this, Constants.TOKEN, "");
        shimmerFrameLayout = findViewById(R.id.shimmerLayout);
        shimmerFrameLayout.startShimmer();
        rv_finance_model.setHasFixedSize(true);
        rv_finance_model.setLayoutManager(new LinearLayoutManager(FinanceActivity.this));
        modes = new ArrayList<>();
    ...
    public void back(View view) {
        startActivity(new Intent(FinanceActivity.this,HomeActivity.class));
        finish();
    }
        ...
        StringRequest requests = new StringRequest(Request.Method.POST, targets_gettargets_url , new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (!response.equals(null)) {
                    ...
                    rv_finance_model.setVisibility(View.VISIBLE);
                    try {
                        ...
                        if(status_code.equals("1")){
                            ...
                            for(int i = 0 ; i < targets.length() ; i++){
                                ...
                                if (name.equals("Finance Target")){
                                    ...
                                    EnquiryTargetAdapter adapter = new EnquiryTargetAdapter(FinanceActivity.this, models);
                                    rv_finance_model.setAdapter(adapter);
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(FinanceActivity.this);
                            ...
                            timer2.schedule(new TimerTask() {
                                public void run() {
                                    ...
                                    if (msg.equals("Invalid API_TOKEN!")){
                                        MyFunctions.setSharedPrefs(FinanceActivity.this, Constants.IS_LOGIN, false);
                                        MyFunctions.setSharedPrefs(FinanceActivity.this, Constants.USER_ID, "");
                                        startActivity(new Intent(FinanceActivity.this, LoginActivity.class).putExtra("DEVICEID",MyFunctions.getSharedPrefs(FinanceActivity.this,Constants.DEVICEID,"")));
                                        finish();
                                    }
                                }
