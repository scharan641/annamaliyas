...
public class BookingTargetActivity extends AppCompatActivity {
    RequestQueue requestQueue;
    String status_code, msg, token, API_TOKEN;
    RecyclerView rv_booking_model , rv_enquiry_mode;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_booking_target);
        getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_LIGHT_STATUS_BAR);
        Window window = BookingTargetActivity.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(BookingTargetActivity.this, R.color.white));
        rv_booking_model = findViewById(R.id.rv_booking_model);
        //rv_enquiry_mode  = findViewById(R.id.rv_enquiry_mode);
        requestQueue = Volley.newRequestQueue(BookingTargetActivity.this);
        API_TOKEN = MyFunctions.getSharedPrefs(BookingTargetActivity.this, Constants.TOKEN, "");
        shimmerFrameLayout = findViewById(R.id.shimmerLayout);
        shimmerFrameLayout.startShimmer();
        rv_booking_model.setHasFixedSize(true);
        rv_booking_model.setLayoutManager(new LinearLayoutManager(BookingTargetActivity.this));
        modes = new ArrayList<>();
        ...
        StringRequest requests = new StringRequest(Request.Method.POST, targets_gettargets_url , new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (!response.equals(null)) {
                    ...
                    rv_booking_model.setVisibility(View.VISIBLE);
                    try {
                        ...
                        if(status_code.equals("1")){
                            ...
                            for(int i = 0 ; i < targets.length() ; i++){
                                ...
                                if (name.equals("Booking Target")){
                                    ...
                                    EnquiryTargetAdapter adapter = new EnquiryTargetAdapter(BookingTargetActivity.this, models);
                                    rv_booking_model.setAdapter(adapter);
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(BookingTargetActivity.this);
                            ...
                            timer2.schedule(new TimerTask() {
                                public void run() {
                                    ...
                                    if (msg.equals("Invalid API_TOKEN!")){
                                        MyFunctions.setSharedPrefs(BookingTargetActivity.this, Constants.IS_LOGIN, false);
                                        MyFunctions.setSharedPrefs(BookingTargetActivity.this, Constants.USER_ID, "");
                                        startActivity(new Intent(BookingTargetActivity.this, LoginActivity.class).putExtra("DEVICEID",MyFunctions.getSharedPrefs(BookingTargetActivity.this,Constants.DEVICEID,"")));
                                        finish();
                                    }
                                }
