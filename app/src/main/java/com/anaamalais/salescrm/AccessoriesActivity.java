...
public class AccessoriesActivity extends AppCompatActivity {
    ...
    RecyclerView rv_accessories_model , rv_enquiry_mode;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Window window = AccessoriesActivity.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(AccessoriesActivity.this, R.color.white));
        rv_accessories_model = findViewById(R.id.rv_accessories_model);
        //rv_enquiry_mode  = findViewById(R.id.rv_enquiry_mode);
        requestQueue = Volley.newRequestQueue(AccessoriesActivity.this);
        API_TOKEN = MyFunctions.getSharedPrefs(AccessoriesActivity.this, Constants.TOKEN, "");
        shimmerFrameLayout = findViewById(R.id.shimmerLayout);
        shimmerFrameLayout.startShimmer();
        rv_accessories_model.setHasFixedSize(true);
        rv_accessories_model.setLayoutManager(new LinearLayoutManager(AccessoriesActivity.this));
        modes = new ArrayList<>();
    ...
    public void back(View view) {
        startActivity(new Intent(AccessoriesActivity.this,HomeActivity.class));
        finish();
    }
        ...
        StringRequest requests = new StringRequest(Request.Method.POST, targets_gettargets_url , new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (!response.equals(null)) {
                    ...
                    rv_accessories_model.setVisibility(View.VISIBLE);
                    try {
                        ...
                        if(status_code.equals("1")){
                            ...
                            for(int i = 0 ; i < targets.length() ; i++){
                                ...
                                if (name.equals("Accessories")){
                                    ...
                                    EnquiryTargetAdapter adapter = new EnquiryTargetAdapter(AccessoriesActivity.this, models);
                                    rv_accessories_model.setAdapter(adapter);
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(AccessoriesActivity.this);
                            ...
                            timer2.schedule(new TimerTask() {
                                public void run() {
                                    ...
                                    if (msg.equals("Invalid API_TOKEN!")){
                                        MyFunctions.setSharedPrefs(AccessoriesActivity.this, Constants.IS_LOGIN, false);
                                        MyFunctions.setSharedPrefs(AccessoriesActivity.this, Constants.USER_ID, "");
                                        startActivity(new Intent(AccessoriesActivity.this, LoginActivity.class).putExtra("DEVICEID",MyFunctions.getSharedPrefs(AccessoriesActivity.this,Constants.DEVICEID,"")));
                                        finish();
                                    }
                                }
