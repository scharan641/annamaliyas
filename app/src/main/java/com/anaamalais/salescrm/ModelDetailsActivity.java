...
import static com.anaamalais.salescrm.Utils.Constants.MODEL_ID;
...
public class ModelDetailsActivity extends AppCompatActivity {
    ...
    com.anaamalais.salescrm.Utils.PreferenceManager preferenceManager;
        ...
        StringRequest requests = new StringRequest(Request.Method.POST, accessoriesmaster_getvehicledetails_url , new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (!response.equals(null)) {
                    progressDialog = new ProgressDialog(ModelDetailsActivity.this);
...
//                                    preferenceManager.setModelId(Variant_id);
            ...
            protected Map<String, String> getParams() {
                ...
                params.put("MODEL_ID",preferenceManager.getModelId());
