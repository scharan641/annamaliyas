...
public class CreateMeeting extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Window window = CreateMeeting.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(CreateMeeting.this, R.color.details));
        ...
        edt_time.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                TimePickerDialog timePickerDialog = new TimePickerDialog(CreateMeeting.this,
    ...
    public void back(View view) {
            startActivity(new Intent(CreateMeeting.this,CustomerViewActivity.class));
            finish();

    }

    public void viewdetails(View view) {
        startActivity(new Intent(CreateMeeting.this,CustomerMeetingActivity.class));
        finish();
    }
}
