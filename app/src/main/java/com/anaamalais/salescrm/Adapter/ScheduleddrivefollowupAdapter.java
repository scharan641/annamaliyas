...
public class ScheduleddrivefollowupAdapter extends RecyclerView.Adapter<ScheduleddrivefollowupAdapter.ScheduleddrivefollowupViewHolder> {

    //this context we will use to inflate the activity_sign_in
    private Context mCtx;
    //we are storing all the products in a list
    private List<ScheduleddrivefollowupList> scheduleddrivefollowupLists;

    String followupdate , followuptime;

    //getting the context and product list with constructor
    public ScheduleddrivefollowupAdapter(Context mCtx, List<ScheduleddrivefollowupList> scheduleddrivefollowupLists) {
        this.mCtx = mCtx;
        this.scheduleddrivefollowupLists = scheduleddrivefollowupLists;
    }

    @Override
    public ScheduleddrivefollowupViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.adapter_contact_followup, null);

        return new ScheduleddrivefollowupViewHolder(view);
    }

    @Override
    public void onBindViewHolder (final ScheduleddrivefollowupViewHolder holder, int position){
        //getting the product of the specified position
        final ScheduleddrivefollowupList allContactsList = scheduleddrivefollowupLists.get(position);
    ...
    public int getItemCount () {
        return scheduleddrivefollowupLists.size();
    }


    class ScheduleddrivefollowupViewHolder extends RecyclerView.ViewHolder {

        TextView txt_count, txt_call_time, txt_type, txt_remark , txt_today_remark;

        public ScheduleddrivefollowupViewHolder(View itemView) {
            super(itemView);
