...
public class FifteenDayFollowupAdapter extends RecyclerView.Adapter<FifteenDayFollowupAdapter.FifteenDayFollowupViewHolder> {


    //this context we will use to inflate the activity_sign_in
    private Context mCtx;
    //we are storing all the products in a list
    private List<FifteenDayFollowupList> fifteenDayFollowupLists;

    String followupdate , followuptime;

    //getting the context and product list with constructor
    public FifteenDayFollowupAdapter(Context mCtx, List<FifteenDayFollowupList> fifteenDayFollowupLists) {
        this.mCtx = mCtx;
        this.fifteenDayFollowupLists = fifteenDayFollowupLists;
    }

    @Override
    public FifteenDayFollowupViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        //inflating and returning our view holder
        LayoutInflater inflater = LayoutInflater.from(mCtx);
        View view = inflater.inflate(R.layout.adapter_contact_followup, null);

        return new FifteenDayFollowupViewHolder(view);
    }

    @Override
    public void onBindViewHolder (final FifteenDayFollowupViewHolder holder, int position){
        //getting the product of the specified position
        final FifteenDayFollowupList allContactsList = fifteenDayFollowupLists.get(position);
    ...
    public int getItemCount () {
        return fifteenDayFollowupLists.size();
    }


    class FifteenDayFollowupViewHolder extends RecyclerView.ViewHolder {

        TextView txt_count, txt_call_time, txt_type, txt_remark , txt_today_remark;

        public FifteenDayFollowupViewHolder(View itemView) {
            super(itemView);
