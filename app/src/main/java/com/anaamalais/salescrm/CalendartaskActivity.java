...
public class CalendartaskActivity extends AppCompatActivity {
    ...
    TextView txt_current_month , txt_no_calander_data;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calendar_view_task);
        Window window = CalendartaskActivity.this.getWindow();
        window.addFlags(WindowManager.LayoutParams.FLAG_DRAWS_SYSTEM_BAR_BACKGROUNDS);
        window.clearFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_STATUS);
        window.setStatusBarColor(ContextCompat.getColor(CalendartaskActivity.this, R.color.customerdetails));
        API_TOKEN = MyFunctions.getSharedPrefs(CalendartaskActivity.this, Constants.TOKEN, "");
        requestQueue = Volley.newRequestQueue(CalendartaskActivity.this);
        ...
        rv_calendar_data.setLayoutManager(new LinearLayoutManager(CalendartaskActivity.this));
        ...
        calendarview.setOnDateChangeListener(new CalendarView.OnDateChangeListener() {
            ...
            public void onSelectedDayChange(CalendarView view, int year, int month, int dayOfMonth) {
                ...
                if (dayOfMonth < 10 || month > 10){
                    String msg = "0"+dayOfMonth + "/" + (month + 1) + "/" + year;
                  //  Toast.makeText(CalendartaskActivity.this, calendatedate, Toast.LENGTH_SHORT).show();
                    SimpleDateFormat spf = new SimpleDateFormat("dd/MM/yyyy");
                    try {
                        Date newDate = spf.parse(msg);
                        spf = new SimpleDateFormat("yyyy-MM-dd");
                        calendatedate = spf.format(newDate);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }

                } else if (dayOfMonth > 10 || month < 10){
                    String msg =  dayOfMonth + "/" + "0"+(month + 1) + "/" + year;
                    SimpleDateFormat spf = new SimpleDateFormat("dd/MM/yyyy");
                    try {
                        Date newDate = spf.parse(msg);
                        spf = new SimpleDateFormat("yyyy-MM-dd");
        ...
        StringRequest requests = new StringRequest(Request.Method.POST, dashboard_getdatecalendardata, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (!response.equals(null)) {
                    ...
                    txt_no_calander_data.setVisibility(View.GONE);
                    ...
                    try {
                        ...
                        if (status_code.equals("1")) {
                            ...
                            AllContactAdapter adapter = new AllContactAdapter(CalendartaskActivity.this, allContactsLists);
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(CalendartaskActivity.this);
