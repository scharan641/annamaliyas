...
public class RetailActivity extends AppCompatActivity {
    ...
    RecyclerView rv_retail_model , rv_enquiry_mode;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        window.setStatusBarColor(ContextCompat.getColor(RetailActivity.this, R.color.white));
        rv_retail_model = findViewById(R.id.rv_retail_model);
        //rv_enquiry_mode  = findViewById(R.id.rv_enquiry_mode);
        requestQueue = Volley.newRequestQueue(RetailActivity.this);
        API_TOKEN = MyFunctions.getSharedPrefs(RetailActivity.this, Constants.TOKEN, "");
        shimmerFrameLayout = findViewById(R.id.shimmerLayout);
        shimmerFrameLayout.startShimmer();
        rv_retail_model.setHasFixedSize(true);
        rv_retail_model.setLayoutManager(new LinearLayoutManager(RetailActivity.this));
        modes = new ArrayList<>();
        ...
        StringRequest requests = new StringRequest(Request.Method.POST, targets_gettargets_url , new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if (!response.equals(null)) {
                    ...
                    rv_retail_model.setVisibility(View.VISIBLE);
                    try {
                        ...
                        if(status_code.equals("1")){
                            ...
                            for(int i = 0 ; i < targets.length() ; i++){
                                ...
                                if (name.equals("Retail Target")){
                                    ...
                                    EnquiryTargetAdapter adapter = new EnquiryTargetAdapter(RetailActivity.this, models);
                                    rv_retail_model.setAdapter(adapter);
                            ...
                            AlertDialog.Builder builder = new AlertDialog.Builder(RetailActivity.this);
                            ...
                            timer2.schedule(new TimerTask() {
                                public void run() {
                                    ...
                                    if (msg.equals("Invalid API_TOKEN!")){
                                        MyFunctions.setSharedPrefs(RetailActivity.this, Constants.IS_LOGIN, false);
                                        MyFunctions.setSharedPrefs(RetailActivity.this, Constants.USER_ID, "");
                                        startActivity(new Intent(RetailActivity.this, LoginActivity.class).putExtra("DEVICEID",MyFunctions.getSharedPrefs(RetailActivity.this,Constants.DEVICEID,"")));
                                        finish();
                                    }
                                }
